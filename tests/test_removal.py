...
class TestRemovalFunctionality:
    ...
    def test_simple_function_removal(self, temp_dir):
        ...
        header_library_pairs, include_dirs, renames, removals, library_class_names, library_namespaces, library_using_statements, visibility = parse_config_file(str(config))
