...
// Generated on: 2025-12-13 14:59:50 UTC
...
public static unsafe partial class SDL
{
    ...
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint AlignedAlloc(uint alignment, uint size);
    ...
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nuint GetEnvUnsafe(string name);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string? GetEnvUnsafeString(string name)
    {
    ...
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial int SetEnvUnsafe(string name, string value, int overwrite);

    [LibraryImport("SDL3", EntryPoint = "SDL_unsetenv_unsafe", StringMarshalling = StringMarshalling.Utf8)]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial int UnsetEnvUnsafe(string name);
